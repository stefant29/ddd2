...
/**
 * REST controller for managing {@link com.dignitas.ddd2.domain.C}.
 */
@RestController
...
public class CResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<C> updateC(@PathVariable(value = "id", required = false) final String id, @RequestBody C c)
        ...
        C result = cRepository.save(c);
        return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, c.getId())).body(result);
    }
    ...
    public ResponseEntity<C> partialUpdateC(@PathVariable(value = "id", required = false) final String id, @RequestBody C c)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, c.getId()));
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<C> getC(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteC(@PathVariable("id") String id) {
