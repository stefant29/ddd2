...
/**
 * REST controller for managing {@link com.dignitas.ddd2.domain.E}.
 */
@RestController
...
public class EResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<E> updateE(@PathVariable(value = "id", required = false) final String id, @RequestBody E e)
        ...
        E result = eRepository.save(e);
        return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, e.getId())).body(result);
    }
    ...
    public ResponseEntity<E> partialUpdateE(@PathVariable(value = "id", required = false) final String id, @RequestBody E e)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, e.getId()));
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<E> getE(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteE(@PathVariable("id") String id) {
